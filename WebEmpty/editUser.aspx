<%@ Page Title="Register"  Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="editUser" Codebehind="editUser.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <legend style="text-align: center">User Info</legend>
    <%--<form class="form-horizontal" runat="server">--%>
     ...
     <%--   <div class="form-group">
            ...
            <div class="col-sm-8  required">
                <input type="text" readonly="readonly" class="form-control" runat="server" id="inputUsername" />
            </div>
        </div>--%>
     <%--   <div class="form-group">
        ...
        <!-- client register -->
        <div  id="clientdiv" class="clientInformation" runat="server">
        ...
        <!-- delivery register -->
        <div id="deliverydiv"  class="hotelInformation" runat="server">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Price Range</label>
                <div class="col-sm-8 form-inline">
        ...
        <!-- product register -->
        <div id="productdiv"  class="memberInfomation" runat="server">
