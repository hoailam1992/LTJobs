<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Search" Codebehind="Search.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div style="width: 77%; margin: 0 auto">
    <asp:ListView ID="ProductList" runat="server" DataKeyNames="Id" GroupItemCount="4" ItemType="WebEmpty.MasterService.ProductItem" SelectMethod="ProductList_GetData">
        <EmptyDataTemplate>
            <table>
                <tr>
