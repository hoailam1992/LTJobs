                        ...
                        case "1":
                            if (Session["ClientId"] != null && long.TryParse(Session["ClientId"].ToString(), out id))
                            {
                                ...
                                if (tempProductBook.IsSuccess && tempProductBook.Result != null)
                                {
                                    ...
                                    inputMonth.Value =tempProductBook.Result.CCExpiredMonth.HasValue? Convert.ToString(tempProductBook.Result.CCExpiredMonth.Value): "" ;
                                    inputYear.Value = tempProductBook.Result.CCExpiredYear.HasValue ? Convert.ToString(tempProductBook.Result.CCExpiredYear.Value) : ""; 
