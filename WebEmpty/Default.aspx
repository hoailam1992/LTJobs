...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:ListView ID="ProductList" runat="server" DataKeyNames="Id" GroupItemCount="5" ItemType="WebEmpty.MasterService.ProductItem" SelectMethod="ProductList_GetData">
        <EmptyDataTemplate>
            <table>
                <tr>
