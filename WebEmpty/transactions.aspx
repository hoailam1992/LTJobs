<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="transactions" Codebehind="transactions.aspx.cs" %>
...
<ItemTemplate>
    ...
    <td>
     ...
     <td>
       ...
       <td>
      <a href="transactioninfo.aspx?Id=<%# Eval("Id") %>">View Detail  </a>
    </td>
</ItemTemplate>
</asp:ListView>
     </div>
